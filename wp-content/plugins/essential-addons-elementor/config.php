    ...
    'elements' => [
        ...
        'filter-gallery' => [
            'dependency' => [
                'css' => [
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/css/view/filterable-gallery.min.css',
                        'type'    => 'self',
                        'context' => 'view',
                    ],
                ],
                'js' => [
                    ...
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/images-loaded/imagesloaded.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/split-type/split-type.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/view/filterable-gallery.min.js',
                        'type'    => 'self',
                        'context' => 'view',
                    ],
                ],
        ...
        'adv-tabs' => [
            'dependency' => [
                'css' => [
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/css/view/advanced-tabs.min.css',
                        'type'    => 'self',
                        'context' => 'view',
                    ],
                ],
                'js' => [
                    [
                        'file' => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/view/advanced-tabs.min.js',
                        'type' => 'self',
                        'context' => 'view',
                    ],
                ],
        ...
        'figma-to-elementor'        => [
            'class'      => '\Essential_Addons_Elementor\Pro\Elements\Figma_To_Elementor',
            'dependency' => [
                'js' => [
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/edit/figma-to-elementor.min.js',
                        'type'    => 'self',
                        'context' => 'edit'
                     ]
                 ]
        ...
        'creative-btn'              => [
            'dependency' => [
                'css' => [
                    ...
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/css/view/liquid_glass_effect_widgets.min.css',
                        'type'    => 'self',
                        'context' => 'view'
                    ]
                 ]
    ...
    'extensions' => [
        'custom-cursor' => [
            ...
            'dependency' => [
		        ...
		        'js'  => [
                    ...
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/90s-cursor-effects.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/phantom-smoke-ghost.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/ghost-following.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/pointer-perticle.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/ink-line.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/glowing-boxes.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/lib-view/cursor/color-balls.min.js',
                        'type'    => 'lib',
                        'context' => 'view',
                    ],
			        [
				        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/edit/custom-cursor.min.js',
				        'type'    => 'self',
				        'context' => 'edit',
			        ],
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/view/custom-cursor.min.js',
                        'type'    => 'self',
                        'context' => 'view',
                    ],
		        ],
        ...
        'liquid-glass-effect'     => [
            'dependency' => [
                'css' => [
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/css/view/liquid-glass-effect.min.css',
                        'type'    => 'self',
                        'context' => 'view'
                    ]
                ],
                'js'  => [
                    [
                        'file'    => EAEL_PRO_PLUGIN_PATH . 'assets/front-end/js/edit/liquid-glass-editor.min.js',
                        'type'    => 'self',
                        'context' => 'edit'
                    ],
                ]
