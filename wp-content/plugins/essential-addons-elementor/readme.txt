...
- Fixed: EA Woo Account Dashboard Widget | Both the Show & Hide Password Icons being visible at the same time on Account Details Tabs
- Fixed: EA Content Protection | Password box showing alignment issues on frontend when it's enabled on Containers
- Fixed: Resolved an issue where button links on the homepage would briefly scroll to the top before redirecting when Essential Addons for Elementor was active
- Fixed: Resolved an issue where the EA Dynamic Gallery failed to display items when filtering by ACF-based categories
- Fixed: EA Content Timeline | Media Alignment Issue in Editor
- Fixed: EA Custom Cursor | Ghost trail effect not appearing on desktop devices
...
- Fixed: EA Testimonial Slider | Sliding items count and border style issue
- Fixed: EA Dynamic Gallery | Visibility issue with Masonry layout
- Fixed: EA Offcanvas | Compatibility with Premium Addons
- Few minor bug fixes & improvements

= 6.7.1 - 02/11/2025 =

- Fixed: EA Image Comparison | Security Enhancement 
- Few minor bug fixes & improvements
