					...
					<div class="tp-feedback-dialog-radio-content">
						...
						<?php } ?>
							...
							<div id="tp-other-reason-textarea-wrapper" style="display:none;">
								<textarea name="issue_text" placeholder="<?php echo esc_html__( 'Please share the reason', 'tpebl' ); ?>"></textarea>
							</div>
						</div>
